  ...
  <div class="app-container">
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item>
        ...
        <el-button type="success" icon="el-icon-magic-stick" @click="openAutoAssembleDialog">自动组卷</el-button>
      </el-form-item>
    </el-form>
    ...
    <!-- 自动组卷对话框 -->
    <el-dialog title="自动抽题组卷（通过存储过程）" :visible.sync="autoAssembleDialogVisible" width="600px">
      <el-form ref="autoForm" :model="autoForm" :rules="autoRules" label-width="120px">
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="归属课程" prop="courseId">
              <el-select v-model="autoForm.courseId" placeholder="选择课程" style="width: 100%">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="试卷名称" prop="title">
              <el-input v-model="autoForm.title" placeholder="输入试卷名称" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="考试时长(分钟)" prop="duration">
              <el-input-number v-model="autoForm.duration" :min="1" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="及格分" prop="passedScore">
              <el-input-number v-model="autoForm.passedScore" :min="1" style="width: 100%" />
            </el-form-item>
          </el-col>
        </el-row>

        <el-divider content-position="left">抽题规则</el-divider>

        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="单选题数量">
              <el-input-number v-model="autoForm.radioCount" :min="0" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="单选题分值">
              <el-input-number v-model="autoForm.radioScore" :min="1" style="width: 100%" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="多选题数量">
              <el-input-number v-model="autoForm.multiCount" :min="0" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="多选题分值">
              <el-input-number v-model="autoForm.multiScore" :min="1" style="width: 100%" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="判断题数量">
              <el-input-number v-model="autoForm.judgeCount" :min="0" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="判断题分值">
              <el-input-number v-model="autoForm.judgeScore" :min="1" style="width: 100%" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="简答题数量">
              <el-input-number v-model="autoForm.saqCount" :min="0" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="简答题分值">
              <el-input-number v-model="autoForm.saqScore" :min="1" style="width: 100%" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="autoAssembleDialogVisible = false">取 消</el-button>
        <el-button type="primary" @click="submitAutoAssemble">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
import { autoAssemblePaper } from '@/api/dbObjects'
...
export default {
  data() {
    return {
      ...
      // 自动组卷相关
      autoAssembleDialogVisible: false,
      courses: [],
      autoForm: {
        courseId: undefined,
        title: '',
  ...
  methods: {
    ...
    openAutoAssembleDialog() {
      ...
      this.autoAssembleDialogVisible = true
      this.$nextTick(() => {
    ...
    submitAutoAssemble() {
      this.$refs.autoForm.validate(valid => {
        if (valid) {
          ...
          autoAssemblePaper(this.autoForm).then(res => {
            loading.close()
            if (res.code) {
              this.$message.success('自动组卷成功，新试卷ID：' + res.data)
              this.autoAssembleDialogVisible = false
              this.getExamPage(this.pageNum, this.pageSize)
            } else {
            ...
            loading.close()
            this.$message.error('自动组卷发生错误: ' + err.message)
          })
        }
      })
    },
