...
},
{
  ...
  },
  {
    ...
    children: [{
      ...
      meta: { title: '课程管理', visible: true, roles: ['teacher', 'admin'], icon: 'el-icon-notebook-2' }
    }]
  },
  {
    ...
    children: [{
      ...
      meta: { title: '章节管理', visible: true, roles: ['teacher', 'admin'], icon: 'el-icon-collection' }
    }]
  },
  {
    path: '/db-maintenance',
    ...
    children: [{
      ...
      meta: { title: '系统维护', visible: true, roles: ['admin'], icon: 'el-icon-receiving' }
    }]
  },
  {
