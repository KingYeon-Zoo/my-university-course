...
(* CORE_GENERATION_INFO = "System,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=System,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=18,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_board_cnt=2,da_mb_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "System.hwdef" *) 
module System
   (clk,
    led_tri_o,
    uart_rtl_rxd,
  ...
  wire clk_in1_1;
  wire [7:0]led_module_GPIO_TRI_O;
  ...
  assign led_tri_o[7:0] = led_module_GPIO_TRI_O;
  ...
  System_axi_gpio_0_0 led_module
       (.gpio_io_o(led_module_GPIO_TRI_O),
        .s_axi_aclk(microblaze_0_Clk),
